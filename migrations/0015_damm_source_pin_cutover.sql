...
-- revision whose Stage 6 investment-range validation rejects partial cost and benefit
-- bounds without crashing. Existing terminal Draft packages and their immutable
-- approval records remain untouched.
  ...
  if exists (
    ...
    where workflow_run.pass = 'workflow'
      ...
      and (
        ...
        or methodology.source_commit is distinct from '2efb26607acc29a687a82a56edc85f53c4a6da69'
  ...
  if new.pass = 'workflow'
     ...
     and not exists (
       ...
       where methodology.run_id = new.id
         ...
         and methodology.source_commit = '2efb26607acc29a687a82a56edc85f53c4a6da69'
...
begin
  ...
  where workflow_run.id = new.run_id
    ...
    and new.damm_source_commit = '2efb26607acc29a687a82a56edc85f53c4a6da69'
...
as $$
  select exists (
    ...
    where package.id = input_package_id
      ...
      and package.damm_source_commit = '2efb26607acc29a687a82a56edc85f53c4a6da69'

...
-- revision whose Stage 6 investment appraisal uses bounded map/reduce calls, adaptive
-- truncation retries, and crash-safe spend/checkpoint recovery. Existing terminal Draft
-- packages and their immutable approval records remain untouched.
  ...
  if exists (
    ...
    where workflow_run.pass = 'workflow'
      ...
      and (
        ...
        or methodology.source_commit is distinct from '1b1734c8a8017cda488b77cf0594b0ca82dae6ee'
  ...
  if new.pass = 'workflow'
     ...
     and not exists (
       ...
       where methodology.run_id = new.id
         ...
         and methodology.source_commit = '1b1734c8a8017cda488b77cf0594b0ca82dae6ee'
...
begin
  ...
  where workflow_run.id = new.run_id
    ...
    and new.damm_source_commit = '1b1734c8a8017cda488b77cf0594b0ca82dae6ee'
...
as $$
  select exists (
    ...
    where package.id = input_package_id
      ...
      and package.damm_source_commit = '1b1734c8a8017cda488b77cf0594b0ca82dae6ee'

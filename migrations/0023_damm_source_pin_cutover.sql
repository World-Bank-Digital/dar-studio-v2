...
-- revision whose paid calls reserve and journal outcomes before transport, whose stage
-- boundaries preserve terminal failures, and whose simulations bind production bytes.
  ...
  if exists (
    ...
    where workflow_run.pass = 'workflow'
      ...
      and (
        ...
        or methodology.source_commit is distinct from '68e1994b5facfaaf0ddc49ba3bec108d9bde2c55'
  ...
  if new.pass = 'workflow'
     ...
     and not exists (
       ...
       where methodology.run_id = new.id
         ...
         and methodology.source_commit = '68e1994b5facfaaf0ddc49ba3bec108d9bde2c55'
...
begin
  ...
  where workflow_run.id = new.run_id
    ...
    and new.damm_source_commit = '68e1994b5facfaaf0ddc49ba3bec108d9bde2c55'
...
as $$
  select exists (
    ...
    where package.id = input_package_id
      ...
      and package.damm_source_commit = '68e1994b5facfaaf0ddc49ba3bec108d9bde2c55'

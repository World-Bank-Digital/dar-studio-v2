-- Cut active workflows and new approval packages over to the merged DAMM source
-- revision whose Stage 6 candidate synthesis performs one checkpointed,
-- original-text-anchored residual-length recovery after the first repair, with bounded
-- per-field targets and no replay of accepted paid work. Existing terminal Draft packages
-- and their immutable approval records remain untouched.
  ...
  if exists (
    ...
    where workflow_run.pass = 'workflow'
      ...
      and (
        ...
        or methodology.source_commit is distinct from '386ccb90904de4109b64b7c62d4ed7beed8daede'
        ...
        or methodology.renderer_sha256 is distinct from '9dc5d6169c2ae6694d9a0dbc165e61d6557b2589075b962e8def98ec13fd6ba8'
      )
  ) then
  ...
  if new.pass = 'workflow'
     ...
     and not exists (
       ...
       where methodology.run_id = new.id
         ...
         and methodology.source_commit = '386ccb90904de4109b64b7c62d4ed7beed8daede'
         ...
         and methodology.renderer_sha256 = '9dc5d6169c2ae6694d9a0dbc165e61d6557b2589075b962e8def98ec13fd6ba8'
     ) then
...
begin
  ...
  where workflow_run.id = new.run_id
    ...
    and new.damm_source_commit = '386ccb90904de4109b64b7c62d4ed7beed8daede'
    ...
    and new.renderer_sha256 = '9dc5d6169c2ae6694d9a0dbc165e61d6557b2589075b962e8def98ec13fd6ba8'
...
as $$
  select exists (
    ...
    where package.id = input_package_id
      ...
      and package.damm_source_commit = '386ccb90904de4109b64b7c62d4ed7beed8daede'
      ...
      and package.renderer_sha256 = '9dc5d6169c2ae6694d9a0dbc165e61d6557b2589075b962e8def98ec13fd6ba8'
  )
$$;

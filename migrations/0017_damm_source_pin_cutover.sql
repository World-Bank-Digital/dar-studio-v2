...
-- revision whose Stage 6 candidate synthesis repairs otherwise-valid overlength title,
-- problem, and rationale fields without replaying the paid source response. Existing
-- terminal Draft packages and their immutable approval records remain untouched.
  ...
  if exists (
    ...
    where workflow_run.pass = 'workflow'
      ...
      and (
        ...
        or methodology.source_commit is distinct from '4b97b2c9090204dfba3aa7c44f41d558005982ee'
  ...
  if new.pass = 'workflow'
     ...
     and not exists (
       ...
       where methodology.run_id = new.id
         ...
         and methodology.source_commit = '4b97b2c9090204dfba3aa7c44f41d558005982ee'
...
begin
  ...
  where workflow_run.id = new.run_id
    ...
    and new.damm_source_commit = '4b97b2c9090204dfba3aa7c44f41d558005982ee'
...
as $$
  select exists (
    ...
    where package.id = input_package_id
      ...
      and package.damm_source_commit = '4b97b2c9090204dfba3aa7c44f41d558005982ee'

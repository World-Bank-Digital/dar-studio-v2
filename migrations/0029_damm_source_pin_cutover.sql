...
-- revision with corrected Exa Contents document-ID validation and safe failure
-- diagnostics; exact source URL binding, accounting and paid-request replay barriers remain.
  ...
  if exists (
    ...
    where workflow_run.pass = 'workflow'
      ...
      and (
        ...
        or methodology.source_commit is distinct from '62fad75c92143999c5ed9ee832c4f671e7ea6963'
  ...
  if new.pass = 'workflow'
     ...
     and not exists (
       ...
       where methodology.run_id = new.id
         ...
         and methodology.source_commit = '62fad75c92143999c5ed9ee832c4f671e7ea6963'
...
begin
  ...
  where workflow_run.id = new.run_id
    ...
    and new.damm_source_commit = '62fad75c92143999c5ed9ee832c4f671e7ea6963'
...
as $$
  select exists (
    ...
    where package.id = input_package_id
      ...
      and package.damm_source_commit = '62fad75c92143999c5ed9ee832c4f671e7ea6963'

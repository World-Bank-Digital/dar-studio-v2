...
-- revision with documented Exa per-URL crawl failure handling and safe diagnostics;
-- exact HTTP/source binding, accounting and paid-request replay barriers remain.
  ...
  if exists (
    ...
    where workflow_run.pass = 'workflow'
      ...
      and (
        ...
        or methodology.source_commit is distinct from 'bbfd605a1469cc83dac6e5f2650341c50ef69130'
  ...
  if new.pass = 'workflow'
     ...
     and not exists (
       ...
       where methodology.run_id = new.id
         ...
         and methodology.source_commit = 'bbfd605a1469cc83dac6e5f2650341c50ef69130'
...
begin
  ...
  where workflow_run.id = new.run_id
    ...
    and new.damm_source_commit = 'bbfd605a1469cc83dac6e5f2650341c50ef69130'
...
as $$
  select exists (
    ...
    where package.id = input_package_id
      ...
      and package.damm_source_commit = 'bbfd605a1469cc83dac6e5f2650341c50ef69130'

...
-- revision whose Stage 6 length repair is deterministically chunked and independently
-- checkpointed, whose zero-spend simulation is reproducible, and whose Stage 1-7 reports
-- and Stage 8 office/spreadsheet exports are offline, styled, and bounded. Existing
  ...
  if exists (
    ...
    where workflow_run.pass = 'workflow'
      ...
      and (
        ...
        or methodology.source_commit is distinct from 'e866e7a1fffd5edb14f53da5e038f69b2ec29af2'
  ...
  if new.pass = 'workflow'
     ...
     and not exists (
       ...
       where methodology.run_id = new.id
         ...
         and methodology.source_commit = 'e866e7a1fffd5edb14f53da5e038f69b2ec29af2'
...
begin
  ...
  where workflow_run.id = new.run_id
    ...
    and new.damm_source_commit = 'e866e7a1fffd5edb14f53da5e038f69b2ec29af2'
...
as $$
  select exists (
    ...
    where package.id = input_package_id
      ...
      and package.damm_source_commit = 'e866e7a1fffd5edb14f53da5e038f69b2ec29af2'

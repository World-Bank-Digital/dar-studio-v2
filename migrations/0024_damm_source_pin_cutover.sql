...
-- revision with verified completed-checkpoint resume accounting, bounded semantic
-- repair at Stages 3, 5, and 7, fail-closed cache integrity, and refreshed tariffs.
  ...
  if exists (
    ...
    where workflow_run.pass = 'workflow'
      ...
      and (
        ...
        or methodology.source_commit is distinct from '76ca33d97f0809a6be7477447786953317aa41b5'
  ...
  if new.pass = 'workflow'
     ...
     and not exists (
       ...
       where methodology.run_id = new.id
         ...
         and methodology.source_commit = '76ca33d97f0809a6be7477447786953317aa41b5'
...
begin
  ...
  where workflow_run.id = new.run_id
    ...
    and new.damm_source_commit = '76ca33d97f0809a6be7477447786953317aa41b5'
...
as $$
  select exists (
    ...
    where package.id = input_package_id
      ...
      and package.damm_source_commit = '76ca33d97f0809a6be7477447786953317aa41b5'

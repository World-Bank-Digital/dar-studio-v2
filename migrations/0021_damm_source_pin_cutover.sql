...
-- revision whose XLSX exports are normalized to their frozen workflow timestamps,
-- preserving byte-identical simulation and package artifacts across host clocks.
  ...
  if exists (
    ...
    where workflow_run.pass = 'workflow'
      ...
      and (
        ...
        or methodology.source_commit is distinct from 'f7dfbbb647e0a45d996e94f62d49f2218d518c94'
  ...
  if new.pass = 'workflow'
     ...
     and not exists (
       ...
       where methodology.run_id = new.id
         ...
         and methodology.source_commit = 'f7dfbbb647e0a45d996e94f62d49f2218d518c94'
...
begin
  ...
  where workflow_run.id = new.run_id
    ...
    and new.damm_source_commit = 'f7dfbbb647e0a45d996e94f62d49f2218d518c94'
...
as $$
  select exists (
    ...
    where package.id = input_package_id
      ...
      and package.damm_source_commit = 'f7dfbbb647e0a45d996e94f62d49f2218d518c94'

...
test("the deployment wizard verifies the append-only DAMM source repin", () => {
  ...
  assert.match(wizard, /MIGRATION_0016_VERIFIED/);
  assert.match(wizard, /0016_damm_source_pin_cutover\.sql/);
  assert.match(wizard, /1b1734c8a8017cda488b77cf0594b0ca82dae6ee/);
